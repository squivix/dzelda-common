        ...
        describe("tokenizeText", async () => {
            ...
            describe<LocalTestContext>("It should tokenize text and correctly identify phrases", () => {
                ...
                ("test case %#", (text: string, phrases: string[], expectedTokens: TokenObject[]) => {
                    const tokens=parser.tokenizeText(text, phrases);
                    console.log(JSON.stringify(tokens))
                    expect(tokens).toEqual(expectedTokens)
                });
            });
        });
        /**{@link SpaceBasedWordParser#transformWords}*/
        describe.todo("transformWords", () => {
        });

        /**{@link SpaceBasedWordParser#combineTokens}*/
        describe.todo("combineTokens", () => {
        });
    });
});
